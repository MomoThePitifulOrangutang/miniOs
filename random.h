...
Purpose: Interface: Simulated page replacer method: RANDOM
*/
...
int random_sched (queue<string> addresses, Frame frames[], Page pages[], int framecount, int framesize, int pagecount);
...
bool rand_find_frame (string currentAddress, Frame frames[], Page pages[], int framecount, int framesize, int pagecount, int &faults);
...
Page rand_find_page (int address, int pagecount, int framesize, Page pages[]);